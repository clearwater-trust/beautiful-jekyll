...
[BISQ](https://bisq.network) is a decentralized exchange that allows you to trade/barter directly with your neighbors through a private network (TOR). [BISQ](https://bisq.network) is a DAO that incentivises fair-play by rewarding contributors through the bitcoin network using colored coins. [Read more about the BISQ DAO here](https://github.com/bisq-network/bisq-docs/blob/master/dao/phase-zero.adoc).
